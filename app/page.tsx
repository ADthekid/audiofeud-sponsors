    ...
    <div className={hankenGrotesk.className}>
      ...
      <section className="about min-h-[800px] h-fit">
        ...
        <div className="flex justify-center">
          <p className="text-center max-w-4xl text-audiofeudpurple md:text-xl sm:text-large text-medium px-4 py-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu <b>fugiat nulla pariatur.</b></p>
        </div>
